...
const screeningFindingTransportSchema = {
  ...
  additionalProperties: false,
  required: [
    'draftId', 'pdfPage', 'blockId', 'originalText', 'issueType', 'ruleType', 'severity',
    'extractionReliability', 'retrievalRequired', 'temporalContext', 'disputeStatus',
  ...
  properties: {
    ...
    extractionReliability: { type: 'string', enum: EXTRACTION_RELIABILITIES },
...
const finalCandidateTransportSchema = {
  ...
  additionalProperties: false,
  required: [
    'draftId', 'issueType', 'ruleType', 'severity', 'verificationStatus', 'retrievalRequired',
    'judgement', 'suggestion', 'reason', 'confidence', 'temporalContext', 'disputeStatus',
